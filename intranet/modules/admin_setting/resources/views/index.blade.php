...
@section('title')
    {{ trans('admin_setting::view.Admin list of division') }}
@endsection
<?php
        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title managetime-box-title">{{ trans('admin_setting::view.add') }}</h3>
                </div>
                <div class="box-body no-padding margin-top-20">
                    <div class="table-responsive" style="overflow-x: hidden">
                        <form method="post" action="{{ route('admin::setting.save-employee') }}">
                            {!! csrf_field() !!}
                            <tr>
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 form-group form-group-select2">
                                        ...
                                        <div class="input-box">
                                            <select name="employees[]" id="employees" class="form-control select-search-employee" data-remote-url="{{ URL::route('manage_time::profile.comelate.ajax-search-employee') }}" multiple>
                                            </select>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-sm-6 form-group form-group-select2">
                                                    ...
                                                    <div class="team-select-box">
                                                        <div class="input-box">
                                                            <select name="groupTeam-edit" id="groupTeam-edit"
                                                                    class="form-control select-search"
                                                                    autocomplete="off">
                                                                <option value="0">&emsp;</option>
                                                                @foreach($teamsOptionAll as $option)
                                                ...
                                                <div class="col-sm-6 form-group form-group-select2">
                                                    <label class="control-label required">{{ trans('admin_setting::view.Employee') }}<em> *</em></label>
                                                    <div class="input-box">
                                                        <select name="employees-edit[]" id="employees-edit" class="form-control" data-remote-url="{{ URL::route('manage_time::profile.comelate.ajax-search-employee') }}" multiple>
                                                        </select>
                        ...
                        <table class="table table-striped dataTable table-bordered table-hover table-grid-data">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ trans('admin_setting::view.Admin') }}</th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody>
                            @foreach($collectionModel as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{route('admin::setting.delete')}}" method="post" class="form-inline">
                                            {{ csrf_field() }}
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $('#employees-edit').selectSearchEmployee();
        });

        function showChangeDataModal(id) {
            $('#speaking-config').modal('show');
            var getData = '{{ route("admin::setting.edit") }}';
            $.ajax ({
                url: getData,
                method : 'POST',
                data: {id: id,
