      ...
      <tr>
        <td>
          <div style="background: #FFFFFF; padding: 10px 40px;">
            ...
            <p>
              Hạn hoàn thành quá trình Hội nhập của bạn sắp đến. Bạn vui lòng xem thông tin tại đây: <a href="{{ config('services.hrm_url').'/hrm/profile/general?isIntegration=1' }}">Link</a> và hoàn thành đầy đủ chậm nhất trong {{ $data['complete_date'] }} để được ghi nhận hoàn thành, nhận {{ $data['gpoint'] }} G-Point và các đánh giá công việc từ Quản lý trực tiếp.
            </p>
            <p>
