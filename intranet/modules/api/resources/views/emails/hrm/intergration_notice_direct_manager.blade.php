                ...
                <tr>
                    <td>
                        <div style="background: #FFFFFF; padding: 10px 40px;">
                            ...
                            <p>Anh/Chị sẽ là quản lý trực tiếp của nhân sự mới {{ $data['employee_name'] }} sẽ gia nhập vào ngày {{ $data['onboard_date'] }}.</p>
                            <p>
                                ...
                                và chuẩn bị nội dung đón tiếp tại đơn vị, trao đổi mục tiêu, định hướng công việc, phân bổ Người hướng dẫn trong thời gian hội nhập.
                            </p>
