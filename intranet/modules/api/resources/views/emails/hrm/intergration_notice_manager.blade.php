                ...
                <tr>
                    <td>
                        <div style="background: #FFFFFF; padding: 10px 40px;">
                            ...
                            <p>Anh/Chị có nhân sự mới {{ $data['employee_name'] }} sẽ gia nhập vào ngày {{ $data['onboard_date'] }}.</p>
                            <p>Vui lòng xem các thông tin tại: 
                                <a href="{{ config('services.hrm_url').'/hrm/management/employees/integration/edit/'.$data['integration_id'] }}">Link</a>
                                và có các hiệu chỉnh thông tin cần thiết:</p>
                            <ul>
                                <li>Người quản lý trực tiếp</li>
