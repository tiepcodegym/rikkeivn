                ...
                <tr>
                    <td>
                        <div style="background: #FFFFFF; padding: 10px 40px;">
                            ...
                            <p>Bộ phận {{ $data['issue_division'] }} vừa ban hành văn bản {{ $data['policy_name'] }}.</p>
                            <p>Xin được thông báo đến Anh/Chị để cùng cập nhật thông tin mới nhất.</p>
                            <p>Để biết thêm chi tiết mời xem <a href="{{ config('services.hrm_url').'/hrm/help/policy/detail/'.$data['id'] }}">Tại đây</a>.</p>
                            <p>Trân trọng!</p>
                        </div>
                    </td>
                </tr>
