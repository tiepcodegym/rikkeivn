      ...
      <tr>
        <td>
          <div style="background: #FFFFFF; padding: 10px 40px;">
            ...
            <p>
              Hệ thống gửi đến Anh/Chị thông tin nhân sự sắp hết hạn hợp đồng như sau:
            </p>
            <p>
            ...
            <p style="margin-top: 24px;">Anh/Chị vui lòng kiểm tra thông tin và xét duyệt gia hạn hợp đồng trước ngày {{ $data['contract_end_date'] }}
