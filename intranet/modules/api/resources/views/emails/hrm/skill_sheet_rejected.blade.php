                ...
                <tr>
                    <td>
                        <div style="background: #FFFFFF; padding: 10px 40px;">
                            ...
                            <p>Hệ thống Rikkei HRM xin thông báo: Thông tin skill sheet của bạn bị từ chối.</p>
                            <p>Vui lòng cập nhật theo nội dung phản hồi <a href="{{ config('services.hrm_url').'/hrm/profile/skill-sheet/' }}">Tại đây</a></p>
                            <p>Trân trọng!</p>
                        </div>
                    </td>
                </tr>
