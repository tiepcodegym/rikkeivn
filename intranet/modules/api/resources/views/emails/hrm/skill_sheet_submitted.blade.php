                ...
                <tr>
                    <td>
                        <div style="background: #FFFFFF; padding: 10px 40px;">
                            ...
                            <p>Hệ thống Rikkei HRM xin thông báo: Nhân sự {{ $data['employee_name'] }} ({{ $data['account'] }}) vừa submit skill sheet.</p>
                            <p>Anh/Chị vui lòng phản hồi trong thời gian sớm nhất <a href="{{ config('services.hrm_url').'/hrm/profile/skill-sheet/'.$data['account'] }}">Tại đây</a></p>
                            <p>Trân trọng!</p>
                        </div>
                    </td>
                </tr>
