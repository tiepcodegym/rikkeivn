      ...
      <tr>
        <td>
          <div style="background: #FFFFFF; padding: 10px 40px;">
            ...
            <p>
              Hợp đồng của nhân sự {{ $data['employee_name'] }} ({{ $data['account'] }}) đã được gia hạn với thông tin cụ thể như sau:
            </p>
            <p>
            ...
            <p style="margin-top: 24px;">Bộ phận nhân sự thông báo đến Anh/Chị để cùng nắm thông tin.
            </p>
            <p>
              Trân trọng.
            </p>
