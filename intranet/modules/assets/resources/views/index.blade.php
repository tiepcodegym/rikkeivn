            ...
            <div class="box box-primary">
                <div class="box-header with-border" id="profile_table">
                    <div class="pull-left">
                        ...
                        <button type="button" class="btn btn-default btn-asset-profile" value="{{ AssetConst::TYPE_LOST_NOTIFY }}">{{ trans('asset::view.Status Lost notification') }}</button>
                        <button type="button" class="btn btn-default btn-asset-profile" value="{{ AssetConst::TYPE_BROKEN_NOTIFY }}">{{ trans('asset::view.Status Broken notification') }}</button>
                        @if ($inventory)
                        <?php
