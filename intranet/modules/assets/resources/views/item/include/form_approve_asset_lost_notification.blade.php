...
<form id="" method="POST" action="{{ route('asset::asset.approve') }}" accept-charset="UTF-8" autocomplete="off">
    {!! csrf_field() !!}
    <input type="hidden" name="state" value="{{ AssetItem::STATE_LOST_NOTIFICATION }}">
    <div class="modal-header">
        <h3 class="modal-title">{{ trans('asset::view.Approval of asset lost notification') }}</h3>
    </div>
    <div class="modal-body">
        <div class="box box-solid box-modal">
            <div class="box-header with-border box-header-modal">
                <h3 class="box-title"><i class="fa fa-globe"></i> {{ trans('asset::view.Asset lost notification list') }}</h3>
            </div>
            <div class="box-body">
                    ...
                    <table class="table table-striped dataTable table-bordered table-hover table-grid-data asset-table" style="width: 1145px; padding-bottom: 20px;" id="table-asset-approval">
                        <thead>
                            <tr>
                                ...
                                <th class="width-90">{{ trans('asset::view.Lost notification date') }}</th>
                                <th class="width-145">{{ trans('asset::view.Lost notification reason') }}</th>
                            </tr>
                        </thead>
