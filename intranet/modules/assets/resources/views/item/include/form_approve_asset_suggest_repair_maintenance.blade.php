...
<form id="" method="POST" action="{{ route('asset::asset.approve') }}" accept-charset="UTF-8" autocomplete="off">
    {!! csrf_field() !!}
    <input type="hidden" name="state" value="{{ AssetItem::STATE_SUGGEST_REPAIR_MAINTENANCE }}">
    <div class="modal-header">
        <h3 class="modal-title">{{ trans('asset::view.Approval of asset suggest repair, maintenance') }}</h3>
    </div>
    <div class="modal-body">
        <div class="box box-solid box-modal">
            <div class="box-header with-border box-header-modal">
                <h3 class="box-title"><i class="fa fa-globe"></i> {{ trans('asset::view.Asset suggest repair, maintenance list') }}</h3>
            </div>
            <div class="box-body">
