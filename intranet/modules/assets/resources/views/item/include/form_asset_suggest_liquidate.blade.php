...
?>
<form id="form_asset_suggest_liquidate" class="form-disabled-submit" method="POST" action="{{ route('asset::asset.asset-suggest-liquidate') }}" accept-charset="UTF-8" autocomplete="off">
    {!! csrf_field() !!}
    <div class="modal-header">
        <h3 class="modal-title">{{ trans('asset::view.Asset suggest liquidate') }}</h3>
    </div>
    <div class="modal-body">
        ...
        <div class="box box-solid">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-info-circle"></i> {{ trans('asset::view.Asset suggest liquidate information') }}</h3>
            </div>
            <div class="box-body">
                <div class="form-group">
                    <label class="control-label required">{{ trans('asset::view.Suggest liquidate date') }} <em>*</em></label>
                     <div class="input-box">
                        <div class="row">
                            <div class="col-sm-5">
                ...
                <div class="form-group">
                    <label class="control-label required">{{ trans('asset::view.Suggest liquidate reason') }} <em>*</em></label>
                    <div class="input-box">
