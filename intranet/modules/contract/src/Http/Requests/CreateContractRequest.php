...
class CreateContractRequest extends FormRequest
{
    ...
    public function validator($factory)
    {
        ...
        $validator->after(function ($validator) {
            ...
            $startAt = Carbon::parse(Input::get('txt_start_at'));
            if ($startAt && $empId) {
            ...
            if ($empId && $endAt) {
                ...
                $messError = $this->validateNotWrapperContract($startAt, $endAt);
                if ($messError != '') {
                    $validator->errors()->add('txt_end_at', $messError);
                }
            }
    ...
    public function validateContractType($contractType, $startAt)
    {
        $empId = Input::get('sel_employee_id');
     ...
     */
    public function validateNotWrapperContract($startAt, $endAt)
    {
        $empId = Input::get('sel_employee_id');
