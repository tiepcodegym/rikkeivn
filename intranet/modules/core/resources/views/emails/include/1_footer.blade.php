...
?>
    <table border="0" cellpadding="0" cellspacing="0" width="600" id="template_footer" style="background: #ffffff;">
        <tr>
            <td width="30">&nbsp;</td>
            <td>
                <table border="0" cellpadding="0" cellspacing="0" width="540">
                    ...
                    <tr>
                        <td width="430" style="text-align: left;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ CoreConfigData::getValueDb('web_url') }}" style="text-decoration: none;" target="_blank">
                                                <img src="{{ URL::asset('/common/images/email_christmas/web.png') }}" style="max-width: 25px;" alt="RikkeiSoft" />
                                            </a>
                                        </td>
                                        <td width="40">&nbsp;</td>
                                        <td>
                                            <a href="{{ CoreConfigData::getValueDb('face_url') }}" style="text-decoration: none;display: inline-block;" target="_blank">
                                                <img src="{{ URL::asset('/common/images/email_christmas/face.png') }}" style="max-width: 25px;" alt="RikkeiSoft" />
                                            </a>
                                        </td>
                                        <td width="40">&nbsp;</td>
                                        <td>
                                            <a href="{{ CoreConfigData::getValueDb('youtube_url') }}" style="text-decoration: none;display: inline-block;" target="_blank">
                                                <img src="{{ asset('common/images/email_christmas/youtube.png') }}" style="max-width: 25px;" alt="RikkeiSoft" />
                                            </a>
                                        </td>
                                    </tr>
                                </table>
