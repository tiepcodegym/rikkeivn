                        ...
                        <div class="col-sm-12">
                            <div class="box-body">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class=""><a href="#employee_tab" data-toggle="tab"
                                                    aria-expanded="false">{{ trans('education::view.Education.employee List') }}</a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane active" id="infomation_tab">
                                        @include('education::manager-courses.includes.manager-detail-infomation')
                                    </div>
                                    <!-- /.tab-pane -->
                                    <div class="tab-pane" id="employee_tab">
                                        @include('education::manager-courses.includes.manager-detail-employee')
                                    </div>
                                </div>
                                <!-- /.tab-content -->
                            </div>
