...
<div class="row">
    <div class="col-sm-12">
        <div class="box box-info">
            <div class="box-body">
                <p><b>{{ trans('event::view.auto send email birthday') }}</b></p>
                <form id="form-event-create" method="post" action="{{ route('event::mail.birthday.employee.save') }}" 
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <input name="cc[event.mail.bitrhday.employee.subject]" class="form-control input-field" type="text" id="subject" 
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 iframe-full-width">
                                    <textarea id="editor-content-birthday" class="text-editor" name="cc[event.mail.bitrhday.employee.content]">{{ $contentEmail }}</textarea>
                                </div>
                                ...
                                <div class="col-md-6 hint-note">
                                    <p>&#123;&#123; {{ trans('event::view.old') }} &#125;&#125;: {{ trans('event::view.age send email celebration') }}</p>
                                    <p>&#123;&#123; {{ trans('event::view.birthday') }} &#125;&#125;: {{ trans('event::view.birthday send email celebration') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group form-label-left form-group-select2 row">
                                ...
                                <div class="col-md-6 fg-valid-custom">
