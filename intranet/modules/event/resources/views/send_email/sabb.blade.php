...
@section('title')
{{ trans('event::view.Send mail sabbatical') }}
@endsection
...
<div class="box box-info">
    <div class="box-body">
        <form id="form-event-create" method="post" action="{{ route('event::sabb.post_upload_file') }}" 
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-md-12">
                ...
                <img src="{{ URL::asset('event/images/template/nghiphep.png') }}" class="img-responsive" />
            </div>
        </div>
    </div>
</div>
