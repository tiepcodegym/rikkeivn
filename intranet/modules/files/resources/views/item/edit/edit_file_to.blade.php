        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title managetime-box-title">{{ trans('files::view.Chi tiết văn bản đến') }}</h3>
                </div>
                <!-- /.box-header -->
                @if($status == $approver && $type == $typeCvden)
                <div class="box-body no-padding">
                    <div class="col-lg-10 col-lg-offset-1">
                        <form role="form" method="post" action="{{ route('file::file.postEditFile') }}" class="managetime-form-register" id="form-register-file" enctype="multipart/form-data" autocomplete="off">
                            {!! csrf_field() !!}
                            @if($itemNumberTo->id)
                                <input type="hidden" name="file_id" value="{{ $itemNumberTo->id }}" />
                            @endif
                            <div class="row">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 form-group form-group-select2">
                                                ...
                                                <div class="input-box">
                                                    <input type="text" name="codeText" class="form-control codeText" value="{{ $itemNumberTo->code_file }}" disabled="" />
                                                    <p class='codeError'></p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row option1 displayNone">
                                            <div class="col-sm-6 form-group form-group-select2">
                                                ...
                                                <div class="input-box">
                                                    <input type="text" name="numberTo" class="form-control" value="{{ $itemNumberTo->number_to }}" disabled="" />
                                                </div>
                                            </div>
                                            <div class="col-sm-6 form-group form-group-select2">
                                            ...
                                            <div class="col-sm-6 form-group form-group-select2">
                                                ...
                                                <div class="input-box">
                                                    <div class='input-group date' id="datetimepicker-date_file_send">
                                                        ...
                                                        <input type="text" name="date_file_send" class="form-control" id="dateOption1" value="{{ Carbon::parse($itemNumberTo->date_file_send)->format('Y-m-d') }}" disabled="" />
                                                    </div>
                                              ...
                                              <label class="control-label required">{{ trans('files::view.Ngày văn bản') }}<em> *</em></label>
                                                <div class="input-box">
                                                    <div class='input-group date' id='datetimepicker-date_file'>
                                                        ...
                                                        <input type="text" name="date_file" class="form-control dateOption2" value="{{ Carbon::parse($itemNumberTo->date_file)->format('Y-m-d') }}" disabled="" />
                                                    </div>
                                        ...
                                        <div class="row option1 displayNone">
                                            <div class="col-sm-6 form-group form-group-select2">
                                                ...
                                                <div class="input-box">
                                                    <input type="text" name="file_to" class="form-control" value="{{ $itemNumberTo->file_to }}" disabled="" />
                                                </div>
                                            </div>
                                            <div class="col-sm-6 form-group form-group-select2">
                                                ...
                                                <div class="input-box">
                                                    ...
                                                    @foreach ($groupTeam as $value)
                                                         <option value="{{ $value->id }}"  <?php if ($itemNumberTo->team_id == $value->id): ?>
                                                             selected
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 form-group form-group-select2">
                                                ...
                                                <div class="input-box">
                                                    <input type="text" name="save_file" class="form-control" disabled="" value="{{ $itemNumberTo->save_file }}" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12 control-label">
                                                    <textarea id="quote_text" class="text-editor" name="quote_text" disabled="">{{ $itemNumberTo->quote_text }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <br/>
                                        <div class="form-group">
                                            ...
                                            <div class="input-box">
                                                <textarea name="note_text" id="note_text" class="form-control" disabled="">{{ $itemNumberTo->note_text }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 form-group-select2">
                                                ...
                                                <div class="input-box">
                                                    <input type="text" name="file_content" class="form-control" disabled value="{{ $itemNumberTo->file_content}}" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 form-group form-group-select2">
                                                <label class="control-label required">{{ trans('files::view.Số kí hiệu') }} <em> *</em></label>
                                                <div class="input-box">
                                                    <input type="text" name="codeText" class="form-control codeText" value="{{ $itemNumberTo->code_file }}" />
                                            ...
                                            <div class="col-sm-6 form-group form-group-select2">
                                                ...
                                                <div class="input-box">
                                                    <div class='input-group date' id="datetimepicker-date_file_send">
                                                        ...
                                                        <input type="text" name="date_file_send" class="form-control" id="dateOption1" value="{{ Carbon::parse($itemNumberTo->date_file_send)->format('Y-m-d') }}" />
                                                    </div>
                                                    <label id="date_file_send-error" class="date_file_send-error error displayNone" for="approver">{{ trans('files::view.The field is required') }}</label>
                                                </div>
                                            </div>
                                              ...
                                              <label class="control-label required">{{ trans('files::view.Ngày văn bản') }}<em> *</em></label>
                                                <div class="input-box">
                                                    <div class='input-group date' id='datetimepicker-date_file'>
                                                        ...
                                                        <input type="text" name="date_file" class="form-control dateOption2" value="{{ Carbon::parse($itemNumberTo->date_file)->format('Y-m-d') }}" />
                                                    </div>
                                                    <label id="date_file-error" class="date_file-error error displayNone" for="approver">{{ trans('files::view.The field is required') }}</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row option1 displayNone">
                                            <div class="col-sm-6 form-group form-group-select2">
                                                <label class="control-label">{{ trans('files::view.Nơi gửi') }}</label>
                                                <div class="input-box">
                                                    <input type="text" name="file_to" class="form-control" value="{{ $itemNumberTo->file_to }}" />
                                                </div>
                                            </div>
                                            <div class="col-sm-6 form-group form-group-select2">
                                                <label class="control-label required">{{ trans('files::view.Đơn vị nhận văn bản') }} <em> *</em></label>
                                                        ...
                                                        <select name="groupTeam" id="groupTeam"
                                                            ...
                                                            <option value="0">&emsp;</option>
                                                                @foreach($teamsOptionAll as $option)
                                                                    ...
                                                                    code="{{ $option['code'] }}" 
                                                                    <?php if ($itemNumberTo->id_teams == $option['value']): ?>
                                                                        selected
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 form-group form-group-select2">
                                                <label class="control-label required managetime-label">{{ trans('files::view.Nơi lưu bản gốc') }}</label>
                                                <div class="input-box">
                                                    <input type="text" name="save_file" class="form-control" value="{{ $itemNumberTo->save_file }}" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <label class="col-sm-12 control-label required">{{ trans('files::view.Trích Yếu') }} <em>*</em></label>
                                                <div class="col-sm-12 control-label">
                                                    <textarea id="quote_text" class="text-editor" name="quote_text">{{ $itemNumberTo->quote_text }}</textarea>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label required">{{ trans('files::view.Ghi chú') }}</label>
                                            <div class="input-box">
                                                <textarea name="note_text" id="note_text" class="form-control">{{ $itemNumberTo->note_text }}</textarea>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="col-sm-12 form-group-select2">
                                                <label class="control-label required">{{ trans('files::view.Tệp nội dung') }}</label><p class="detaiFile">{{ $itemNumberTo->file_content}}</p>
                                                <div class="input-box">
