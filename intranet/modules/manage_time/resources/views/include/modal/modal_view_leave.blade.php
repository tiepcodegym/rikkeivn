...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h3 class="box-title">{{ trans('manage_time::view.Register information of leave day') }}</h3>
        </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6 managetime-form-group">
                                ...
                                <div class="input-box">
                                    <select id="substitute" name="substitute" class="form-control managetime-select-2" disabled>
                                        @if($registerRecord->substitute_name)
                                            <option selected>{{ $registerRecord->substitute_name . ' (' . preg_replace('/@.*/', '',$registerRecord->substitute_email) . ')' }}</option>
                                        @endif
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 managetime-form-group">
                                ...
                                <div class='input-group date' id='datetimepicker-start-date'>
                                    ...
                                    <input type='text' class="form-control managetime-date" name="start_date" id="start_date" data-date-format="DD-MM-YYYY HH:mm:ss" value="{{ Carbon::parse($registerRecord->date_start)->format('d-m-Y H:i:s') }}" disabled />
                                </div>
                            </div>
                            <div class="col-sm-6 managetime-form-group">
                                ...
                                <div class='input-group date' id='datetimepicker-end-date'>
                                    ...
                                    <input type='text' class="form-control" name="end_date" id="end_date" data-date-format="DD-MM-YYYY HH:mm:ss" value="{{ Carbon::parse($registerRecord->date_end)->format('d-m-Y H:i:s') }}" disabled />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 managetime-form-group">
                                <label class="control-label required managetime-label">{{ trans('manage_time::view.Leave day type') }} <em>*</em></label>
                                <div class="input-box">
                                    <select id="reason" class="form-control managetime-select-2" name="reason" disabled>
                                        <option>{{ $registerRecord->reason }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6 managetime-form-group">
                                ...
                                <div class="input-box">
                                    <input type="text" id="salary_rate" name="salary_rate" class="form-control" value="{{ $registerRecord->salary_rate }} %" readonly />
                                </div>
                            </div>
                        </div>
                    
                        <div class="form-group">
                            <label class="control-label required managetime-label">{{ trans('manage_time::view.Leave day reason') }} <em>*</em></label>
                            <div class="input-box">
                                <textarea id="node" name="node" class="form-control required managetime-textarea" disabled>{{ $registerRecord->note }}</textarea>
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
        ...
        <div class="modal-footer">
            ...
            <a class="pull-right" href="{{ route('manage_time::profile.leave.detail', ['id' => $registerRecord->register_id]) }}"><button type="button" class="btn btn-primary">{{ trans('manage_time::view.See details') }}</button></a>
        </div>
    </div><!-- /.modal-content -->
</div><!-- /.modal-dialog -->