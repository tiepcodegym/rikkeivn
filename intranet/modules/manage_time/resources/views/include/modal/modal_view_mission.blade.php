...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h3 class="box-title">{{ trans('manage_time::view.Register information of business trip') }}</h3>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6 managetime-form-group">
                                <label class="control-label required managetime-label">{{ trans('manage_time::view.Out date') }} <em>*</em></label>
                            ...
                            <div class="col-sm-6 managetime-form-group">
                                <label class="control-label required managetime-label">{{ trans('manage_time::view.On date') }} <em>*</em></label>
                        ...
                        <div class="row">
                            <div class="col-sm-6 managetime-form-group">
                                ...
                                <div class="input-box">
                                    <input type="text" name="number_days_off" id="number_days_off" class="form-control" value="{{ $registerRecord->number_days_business_trip }}" disabled />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 managetime-form-group">
                                ...
                                <div class="input-box">
                                    <input type="text" id="location" name="location" class="form-control" value="{{ $registerRecord->location }}" disabled />
                                </div>
                            </div>
                            <div class="col-sm-6 managetime-form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-box">
                                <textarea id="reason" name="reason" class="form-control required managetime-textarea" disabled>{{ $registerRecord->purpose }}</textarea>
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->
        ...
        <div class="modal-footer">
            ...
            <a class="pull-right" href="{{ route('manage_time::profile.mission.detail', ['id' => $registerRecord->register_id]) }}"><button type="button" class="btn btn-primary">{{ trans('manage_time::view.See details') }}</button></a>
        </div>
    </div><!-- /.modal-content -->
</div><!-- /.modal-dialog -->