<?php
    ...
    $countRegistersCreatedBy = BusinessTripRegister::countRegistersCreatedBy($userCurrent->id);
    ...
    $countRegistersApprovedBy = BusinessTripRegister::countRegistersApprovedBy($userCurrent->id);
    $countRegistersRelaterBy = BusinessTripRegister::countRegistersRelatesBy($userCurrent->id);
?>

<div class="box box-solid" id="box_register">
    <div class="box-header with-border">
        <div class="pull-left managetime-menu-title">
            <h3 class="box-title">{{ trans('manage_time::view.My business trip') }}</h3>
        </div>
    ...
    <div class="box-body no-padding">
        <ul class="nav nav-pills nav-stacked managetime-menu">
            <li>
                <a href="{{ route('manage_time::profile.mission.register') }}">
                    <i class="fa fa-share-square-o"></i> {{ trans('manage_time::view.Register') }}
                </a>
            </li>
            <li>
                <a href="{{ route('manage_time::profile.mission.register-list') }}">
                    <i class="fa fa-inbox"></i> {{ trans('manage_time::view.All') }}
                    <span class="label bg-aqua pull-right">{{ $countRegistersCreatedByAll }}</span>
                </a>
            </li>
            <li>
                <a href="{{ route('manage_time::profile.mission.register-list', ['status' => $statusUnapprove]) }}">
            ...
            <li>
                <a href="{{ route('manage_time::profile.mission.register-list', ['status' => $statusApproved]) }}">
            ...
            <li>
                <a href="{{ route('manage_time::profile.mission.register-list', ['status' => $statusDisapprove]) }}">
...
@if($isScopeApproveOfSelf || $isScopeApproveOfTeam || $isScopeApproveOfCompany)
    <div class="box box-solid" id="box_approve">
        <div class="box-header with-border">
            <div class="pull-left managetime-menu-title">
                <h3 class="box-title">{{ trans('manage_time::view.I approves business trip register') }}</h3>
            </div>
            <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                </button>
        ...
        <div class="box-body no-padding">
            <ul class="nav nav-pills nav-stacked managetime-menu">
                <li>
                    <a href="{{ route('manage_time::profile.mission.approve-list') }}">
                        <i class="fa fa-inbox"></i> {{ trans('manage_time::view.All') }}
                ...
                <li>
                    <a href="{{ route('manage_time::profile.mission.approve-list', ['status' => $statusUnapprove]) }}">
                        <i class="fa fa-hourglass-half"></i> {{ trans('manage_time::view.Unapprove') }}
                        @if(count($countRegistersApprovedBy))
                ...
                <li>
                    <a href="{{ route('manage_time::profile.mission.approve-list', ['status' => $statusApproved]) }}">
                        <i class="fa fa-check"></i> {{ trans('manage_time::view.Approved') }}
                        @if(count($countRegistersApprovedBy))
                ...
                <li>
                    <a href="{{ route('manage_time::profile.mission.approve-list', ['status' => $statusDisapprove]) }}">
                        <i class="fa fa-calendar-times-o"></i> {{ trans('manage_time::view.Disapprove') }}
                        @if(count($countRegistersApprovedBy))
...
<div class="box box-solid" id="box_approve">
    <div class="box-header with-border">
        <div class="pull-left managetime-menu-title">
            <h3 class="box-title">{{ trans('manage_time::view.Business trip relates to me') }}</h3>
        </div>
        <div class="box-tools pull-right">
            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
            </button>
    ...
    <div class="box-body no-padding">
        <ul class="nav nav-pills nav-stacked managetime-menu">
            <li>
                <a href="{{ route('manage_time::profile.mission.relates-list') }}">
                    <i class="fa fa-inbox"></i> {{ trans('manage_time::view.All') }}
            ...
            <li>
                <a href="{{ route('manage_time::profile.mission.relates-list', ['status' => $statusUnapprove]) }}">
                    <i class="fa fa-hourglass-half"></i> {{ trans('manage_time::view.Unapprove') }}
                    @if(count($countRegistersRelaterBy))
                            <span class="label bg-yellow pull-right">{{ $countRegistersRelaterBy->status_unapprove }}</span>                    @endif
                </a>
            </li>
            <li>
                <a href="{{ route('manage_time::profile.mission.relates-list', ['status' => $statusApproved]) }}">
                    <i class="fa fa-check"></i> {{ trans('manage_time::view.Approved') }}
                    @if(count($countRegistersRelaterBy))
            ...
            <li>
                <a href="{{ route('manage_time::profile.mission.relates-list', ['status' => $statusDisapprove]) }}">
                    <i class="fa fa-calendar-times-o"></i> {{ trans('manage_time::view.Disapprove') }}
                    @if(count($countRegistersRelaterBy))
