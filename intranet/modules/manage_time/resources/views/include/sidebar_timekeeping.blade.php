...
<div class="box box-solid" id="box_register">
    <div class="box-header with-border">
        <div class="pull-left managetime-menu-title">
            <h3 class="box-title">{{ trans('manage_time::view.Timekeeping details from time to time') }}</h3>
        </div>
            ...
            @if (count($listMenuTimekeeping))
                @foreach ($listMenuTimekeeping as $item)
                    ...
                    <li class="timekeeping-time-to-time">
                        <a class="{{ $classActive }}" href="{{ route('manage_time::timekeeping.timekeeping-detail', ['timekeepingTableId' => $item->timekeeping_table_id]) }}" style="cursor: pointer;">
