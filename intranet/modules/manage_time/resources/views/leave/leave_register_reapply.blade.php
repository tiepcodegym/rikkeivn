...
@section('content-common')
    ...
    <div class="box box-primary" id="mission_register">
		...
		<div class="box-body no-padding">
			@if($isShowFormEdit)
				<form role="form" method="post" action="{{ route('manage_time::profile.leave.save') }}" class="managetime-form-register" id="form-edit-register" enctype="multipart/form-data" autocomplete="off">
				{!! csrf_field() !!}
			@endif
			    <div class="row">
