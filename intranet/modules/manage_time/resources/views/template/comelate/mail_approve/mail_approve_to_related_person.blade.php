...
@section('content')
	...
	<span class="managetime-span-black">{{ trans('manage_time::view.Have employee :registrant_name register late in early out as below need notification to you.', ['registrant_name' => $data['registrant_name']]) }}</span> <br>
