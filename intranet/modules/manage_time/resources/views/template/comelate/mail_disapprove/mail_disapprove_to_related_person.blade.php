...
@section('content')
	...
	<span class="managetime-span-black">{{ trans('manage_time::view.The register of late in early out of :registrant_name, :team_name related to you is considered:', ['registrant_name' => $data['registrant_name'], 'team_name' => $data['team_name']]) }} <b>{{ $data['status'] }}</b></span> <br>
