...
@section('content')
	...
	<span class="managetime-span-black">{{ trans('manage_time::view.Have employee :registrant_name register leave day as below need notification to you.', ['registrant_name' => $data['registrant_name']]) }}</span> <br>
	...
	<span class="managetime-span-black">{{ trans('manage_time::view.State:') }} <b>{{ $data['status'] }}</b></span> <br>
