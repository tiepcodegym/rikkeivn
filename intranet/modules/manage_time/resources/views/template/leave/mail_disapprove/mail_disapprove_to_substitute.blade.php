...
@section('content')
	...
	<span class="managetime-span-black">{{ trans('manage_time::view.The register of leave day of :registrant_name which you replace job is considered:', ['registrant_name' => $data['registrant_name']]) }} <b>{{ $data['status'] }}</b></span> <br>
