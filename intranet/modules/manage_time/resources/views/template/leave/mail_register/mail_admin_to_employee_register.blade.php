...
@section('content')
	...
	<span class="managetimemanagetime-span-black">{{trans('manage_time::view.Register create waiting approval')}}</span> <br>
	...
	<ul class="managetime-span-black">
		...
		<li class="managetime-span-black">{{ trans('manage_time::view.Approver name') }} : {!! $data['approver_name'] !!}, {!! $data['position_appover'] !!}</li>
	</ul>
