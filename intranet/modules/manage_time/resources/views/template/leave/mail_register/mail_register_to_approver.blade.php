...
@section('content')
	...
	<span class="managetimemanagetime-span-black">{{ trans('manage_time::view.Have employee :registrant_name register leave day as below need your approval.', ['registrant_name' => $data['registrant_name']]) }}</span> <br>
