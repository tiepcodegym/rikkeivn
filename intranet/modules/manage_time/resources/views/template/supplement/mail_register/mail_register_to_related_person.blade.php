...
@section('content')
	...
	<span class="managetime-span-black">{{ trans('manage_time::view.From :start_time of date :start_date to :end_time of date :end_date, there was a :registrant_name employee, :team_name, registered supplement has related to you.', ['start_time' => $data['start_time'], 'start_date' => $data['start_date'], 'end_time' => $data['end_time'], 'end_date' => $data['end_date'], 'registrant_name' => $data['registrant_name'], 'team_name' => $data['team_name']]) }}</span> <br>
