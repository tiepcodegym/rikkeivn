...
<div class="box box-info _me_review_page">
    <div id="me_view_member_container"></div>
</div>
...
<script>
    pageParams = $.extend({}, pageParams, {
        urlOldMe: "{{ route('project::project.eval.leader_view_of_team') }}",
    });
</script>
<script type="text/javascript" src="{{ CoreUrl::asset('me/js/me-view-member.js') }}"></script>
<script>
    (function ($) {
        $(document).ready(function () {
            $('#btn_init_view_member').click();
        });
    })(jQuery);
</script>
@endsection
