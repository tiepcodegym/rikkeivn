...
@section('content')
    ...
    <span class="managetime-span-black">{{ trans('ot::view.The overtime registration :registrant_name and register for you has been considered:', ['registrant_name' => $data['register_name']]) }} <b>{{ $data['status'] }}</b></span> <br> <br>
