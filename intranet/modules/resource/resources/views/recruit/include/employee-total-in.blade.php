            ...
            <table class="table table-striped table-bordered table-hover table-grid-data">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item['empname'] }}</td>
                        <td>
                            @if ($item['type'] == 1 && $item['working_type'] == getOptions::WORKING_BORROW)
                                {{ trans('team::profile.Contract borrow') }}
                            @else
                                {{ getOptions::getWorkingTypeLabel($item['working_type']) }}
                            @endif
                        </td>
                    ...
                    @else
                    <tr>
                        <td colspan="11" class="text-center"><h3>{{ trans('resource::message.No data') }}</h3></td>
                    </tr>
                    @endif
                </tbody>
            </table>
