...
@section('title', trans('resource::view.Edit team'))
...
<div class="box box-info">
    <div class="box-body">
        ...
        {!! Form::open(['method' => 'put', 'route' => ['resource::plan.team.update', $item->id]]) !!}
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control select-search" name="team_alias">
                            ...
                            @if ($teamList)
                                ...
                                <option value="{{ $team['value'] }}" {{ $team['value'] == $item->team_alias ? 'selected' : '' }}>{{ $team['label'] }}</option>
                                @endforeach
                            @endif
                        </select>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="checkbox" name="is_soft_dev" {{ $item->is_soft_dev ? 'checked' : '' }} >
                    </div>
                </div>
                ...
                <div class="text-center">
                    ...
                    <button type="submit" class="btn-edit"><i class="fa fa-save"></i> {{ trans('resource::view.Save') }}</button>
                </div>
