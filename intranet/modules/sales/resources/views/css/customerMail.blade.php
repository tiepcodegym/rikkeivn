...
@if($data['lang'] == "en")
    ...
    <!-- send mail first -->
    @else 
    <p style="margin-top: 25px;">Thank you for the opportunity to work with you.</p>
    <p style="margin-top: 25px;">At Rikkeisoft, we aim to further improve our services to better meet your expections,  <br> a small Customer Satisfaction survey will be conducted once the project has been completed.</br></p>

    <p style="margin-top: 25px;">We appreciate all comments or suggestions you might have,
    <br>so would you please spend a several minutes completing the survey at the link below</p>
    @endif

    <p><a style="word-break: break-all;" href="{{$data['hrefMake']}}">{{$data['hrefMake']}}</a></p>
    <p>Thank you very much for your cooperation. We're looking forwards to work with you again in the near future.</p>
