...
$disabledAssign = '';
$disabledParticipant = '';
$taskItem->type = Task::TYPE_COMMENDED;
?>
<div class="modal fade" id="feedbackModal" style="display: none;">
   <div class="modal-dialog modal-lg" style="width: 90%;">
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span></button>
            <h4 class="modal-title">{{ trans('project::view.Customer feedback') }}</h4>
         </div>
         <div class="modal-body">
            <div class="modal-ncm-editor-main">
               <div class="row">
                  <div class="col-sm-12">
                        <form id="form-task-edit-customer" method="post" action="{{route('sales::tracking.saveTasks')}}" class="form-horizontal form-submit-ajax has-valid" autocomplete="off" data-callback-success="myTaskCallBack">
                         {!! csrf_field() !!}
