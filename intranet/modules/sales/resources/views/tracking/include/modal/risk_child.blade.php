...
$disabledAssign = '';
$disabledParticipant = '';
$taskItem->type = Task::TYPE_RISK;

?>

<div class="modal fade" id="riskchildModal" style="display: none;">
   <div class="modal-dialog modal-lg" style="width: 90%;">
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span></button>
            <h4 class="modal-title">{{ trans('project::view.Please enter an introducer') }}</h4>
         </div>
         <div class="modal-body">
            <div class="modal-ncm-editor-main">
               <div class="row">
                    <form id="form-task-edit-child-risk" method="post" action="{{route('sales::tracking.saveTasks')}}" class="form-horizontal form-submit-ajax has-valid" autocomplete="off" data-callback-success="myTaskCallBack">
                        {!! csrf_field() !!}
                        <input type="hidden" name="task[project_id]" value="">
