...
<div class="row">
    <div class="col-md-12">
        <p>
            <a href="{!!route('team::member.profile.index', ['employeeId' => $employeeModelItem->id, 'type' => 'comexper'])!!}">
                <u>{!!trans('team::profile.Company history')!!}</u>
            </a>
        </p>
    </div>
</div>
    ...
    <table class="table table-striped dataTable table-bordered table-hover table-grid-data">
        <thead>
            <tr>
                ...
                <th class="sorting {!!TeamConfig::getDirClass('position')!!}" data-order="position" data-dir="{!!TeamConfig::getDirOrder('position')!!}">{{ trans('team::profile.Position location') }}</th>
                <th class="sorting {!!TeamConfig::getDirClass('no_member')!!}" data-order="no_member" data-dir="{!!TeamConfig::getDirOrder('no_member')!!}">{{ trans('team::profile.Number member') }}</th>
        ...
        <tbody>
            <tr class="filter-input-grid">
                ...
                <td>
                    <div class="row">
                        <div class="col-md-12">
                            <input type="text" name="filter[number][no_member]" value="{{ Form::getFilterData('number', 'no_member') }}" placeholder="{{ trans('team::view.Search') }}..." class="filter-grid form-control" autocomplete="off" />
                        </div>
                    </div>
                </td>
                <td>
                ...
                <tr>
                    ...
                    <td class="{!!$isAccessSubmitForm!!}">
                        <button class="btn-delete" title="{{ trans('core::view.Remove') }}"
                            ...
                            data-submit-noti="{!!trans('team::profile.Are you sure delete this project?')!!}"
