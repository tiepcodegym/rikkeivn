...
@section('content')
	...
	<span class="ticket-span-black">{{ trans('ticket::view.You received a request from') }} <b>{{ $data['ticket_created_by'] }}</b>.</span> <br>

	<span class="ticket-span-black">{{ trans('ticket::view.Please coordinate with :name to resolve the matter in the shortest possible time.', ['name' => $data['ticket_created_by']]) }} </span><br>
