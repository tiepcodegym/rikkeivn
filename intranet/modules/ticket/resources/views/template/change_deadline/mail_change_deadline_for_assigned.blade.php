...
@section('content')
	...
	<span class="ticket-span-black">{{ trans('ticket::view.The work you are doing has changed the deadline.') }}</span> <br>
	...
	<span class="ticket-span-black">{{ trans('ticket::view.Deadline current:') }} <b>{{ $data['ticket_deadline'] }}</b></span> <br>

	<span class="ticket-span-black">{{ trans('ticket::view.Person change deadline:') }} <b>{{ $data['ticket_updated_by'] }}</b></span> <br>
