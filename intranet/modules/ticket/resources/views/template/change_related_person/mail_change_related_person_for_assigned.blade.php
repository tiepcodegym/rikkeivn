...
@section('content')
	...
	<span class="ticket-span-black">{{ trans('ticket::view.The work you are doing has changed the related person.') }}</span> <br>
	...
	<span class="ticket-span-black">{{ trans('ticket::view.Person change related person:') }} <b>{{ $data['ticket_updated_by'] }}</b></span> <br>
