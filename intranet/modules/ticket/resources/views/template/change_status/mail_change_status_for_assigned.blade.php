...
@section('content')
	...
	<span class="ticket-span-black">{{ trans('ticket::view.The work you are doing has changed the status.') }}</span> <br>
	...
	<span class="ticket-span-black">{{ trans('ticket::view.Person change status:') }} <b>{{ $data['ticket_updated_by'] }}</b></span> <br>
