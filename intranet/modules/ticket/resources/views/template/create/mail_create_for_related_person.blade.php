...
@section('content')
	...
	<span class="ticket-span-black">{{ trans('ticket::view.There is a request to resolve work from :ticket_created_by regarding you.', ['ticket_created_by' => $data['ticket_created_by']]) }}</span> <br>
