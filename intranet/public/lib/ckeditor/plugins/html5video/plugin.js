CKEDITOR.plugins.add( 'html5video', {
    ...
    init: function( editor ) {
        editor.widgets.add( 'html5video', {
            ...
            data: function() {
                ...
                if ( this.data.src ) {
                    ...
                    this.element.getChild( 0 ).setAttribute( 'class', 'test-audio' );
        ...
        //add button
        editor.ui.addButton('Rkaudio', {
           label: 'Chèn audio',
           command: 'html5video',
           toolbar: 'insert',
           icon: this.path + 'icons/rkaudio.png'
        });
        //add css
        editor.addContentsCss(this.path + 'style/rkaudio.css');
