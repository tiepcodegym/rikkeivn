(function ($) {
    ...
    $.fn.inputTags.defaults = {
        ...
        errors: {
            empty: 'Attention, you can not add an empty tag.',
            minLength: 'Attention, your tag must have at least %s characters.',
            maxLength: 'Attention, your tag should not exceed %s characters.',
            max: 'Attention, the number of tags must not exceed %s.',
            email: 'Attention, email address is invalid.',
            exists: 'Attention, tag already exists!',
