...
function table_to_book_str(table, opts) {
    return sheet_to_workbook(parse_dom_table_str(table, opts), opts);
}
function parse_dom_table_str(table, _opts) {
    var opts = _opts || {};
    if(DENSE != null) opts.dense = DENSE;
    var ws = opts.dense ? ([]) : ({});
    var rows = table.getElementsByTagName('tr');
...
var utils = {
	...
	table_to_book_str: table_to_book_str
};
