...
$(function() {
    ...
    $('#datetimepicker-start-date').datepicker('setDate', startDateDefault);
    $('#datetimepicker-end-date').datepicker('setDate', endDateDefault);
...
function checkExistRegister(dateStart, dateEnd, registerId, employeeId) {
